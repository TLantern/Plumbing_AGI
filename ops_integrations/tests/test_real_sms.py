#!/usr/bin/env python3
"""
Real SMS test with actual Twilio and ChatGPT APIs
"""
import os
import sys
...
def test_real_sms_with_gpt():
    """Test the SMS system with real Twilio and ChatGPT APIs."""
    print("🚀 Real SMS Test with Twilio + ChatGPT\n")
    ...
    if missing_vars:
        ...
        print("   export TWILIO_FROM_NUMBER='your_twilio_number'")
        print("   export OPENAI_API_KEY='your_openai_key'")
        return False
    
    print("✅ All environment variables found!")
    print(f"   Twilio SID: {os.getenv('TWILIO_ACCOUNT_SID')[:10]}...")
    print(f"   Twilio Number: {os.getenv('TWILIO_FROM_NUMBER')}")
    ...
    try:
        ...
        if not sms.enabled:
            print("❌ SMS adapter not enabled. Check your Twilio credentials.")
            return False
        ...
        print("3. Real SMS messages were sent via Twilio")
...
def test_single_message():
    ...
    if not all([os.getenv('TWILIO_ACCOUNT_SID'), os.getenv('TWILIO_AUTH_TOKEN'), 
                os.getenv('TWILIO_FROM_NUMBER'), os.getenv('OPENAI_API_KEY')]):
        print("❌ Please set all required environment variables first.")
        return False
...
def main():
    ...
    while True:
        print("\nChoose an option:")
        print("1. Test with predefined messages (real Twilio + ChatGPT)")
